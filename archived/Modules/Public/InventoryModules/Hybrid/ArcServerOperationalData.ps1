...
.Link
https://github.com/Hybrid-Solutions-Cloud/azure-scout/Modules/Public/InventoryModules/Hybrid/ArcServerOperationalData.ps1
...
If ($Task -eq 'Processing')
{
    ...
    if ($arcServers) {
        ...
        $tmp = foreach ($1 in $arcServers) {
            ...
            } catch { Write-Debug ('ArcServerOperationalData: failed to read patch assessment: ' + $_.Exception.Message) }
