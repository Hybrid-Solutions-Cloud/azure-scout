...
.Link
https://github.com/Hybrid-Solutions-Cloud/azure-scout/Modules/Private/Reporting/Export-AZSCAsciiDocReport.ps1
...
function Export-AZSCAsciiDocReport {
    ...
    $lines.Add("[NOTE]")
    $lines.Add('====')
    $lines.Add("Generated by link:https://github.com/Hybrid-Solutions-Cloud/azure-scout[AzureScout] at $genDate")
    $lines.Add('====')
