...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Delivery Type'
            Expression = '$data.deliveryType'
        }
        @{
            Name = 'Start Time'
            Expression = '[string]$data.startTime'
        }
        @{
            Name = 'Cancellation Reason'
            Expression = '$data.cancellationReason'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Data Box Jobs'
        TableNamePrefix = 'DataBoxTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
