...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '$AssessmentSolution'
        }
        @{
            Name = 'Workspace Location'
            Expression = '$data.customerWorkspaceLocation'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Migrate Assessment Projects'
        TableNamePrefix = 'AzureMigrateAssessmentsTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
