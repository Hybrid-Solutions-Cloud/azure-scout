...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Device Status'
            Expression = '$data.dataBoxEdgeDeviceStatus'
        }
        @{
            Name = 'Device Type'
            Expression = '$data.deviceType'
        }
        @{
            Name = 'Model'
            Expression = '$data.modelDescription'
        }
        @{
            Name = 'Software Version'
            Expression = '$data.deviceSoftwareVersion'
        }
        @{
            Name = 'Serial Number'
            Expression = '$data.serialNumber'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Stack Edge Devices'
        TableNamePrefix = 'StackEdgeTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
