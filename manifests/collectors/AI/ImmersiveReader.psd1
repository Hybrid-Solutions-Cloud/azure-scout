#
# GENERATED by scripts/ConvertTo-ScoutCollectorDefinition.ps1 from Modules/Public/InventoryModules/AI/ImmersiveReader.ps1 (AB#5660).
...
@{
    ...
    AdditionalFilter = '$_.Kind -eq ''ImmersiveReader'''
...
'@
    ...
    AdditionalRowLoops = @(
        @{
            ...
            # loop always runs at least once and an Immersive Reader account keeps its row.
            #
    ...
    Export = @{
        WorksheetName = 'Immersive Reader'
        TableNamePrefix = 'ImmersiveRTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
    ...
    SourceCollector = 'Modules/Public/InventoryModules/AI/ImmersiveReader.ps1'
}
