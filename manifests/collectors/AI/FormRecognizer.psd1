#
# GENERATED by scripts/ConvertTo-ScoutCollectorDefinition.ps1 from Modules/Public/InventoryModules/AI/FormRecognizer.ps1 (AB#5660).
...
@{
    ...
    AdditionalFilter = '$_.Kind -eq ''FormRecognizer'''
...
'@
    ...
    AdditionalRowLoops = @(
        @{
            ...
            # loop always runs at least once and a Document Intelligence (Form Recognizer) account
            # keeps its row.
            #
    ...
    Export = @{
        WorksheetName = 'Doc Intelligence'
        TableNamePrefix = 'DocIntTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
    ...
    SourceCollector = 'Modules/Public/InventoryModules/AI/FormRecognizer.ps1'
}
