#
# GENERATED by scripts/ConvertTo-ScoutCollectorDefinition.ps1 from Modules/Public/InventoryModules/AI/AIFoundryHubs.ps1 (AB#5660).
...
@{
    ...
    AdditionalFilter = '$_.KIND -eq ''Hub'''
...
'@
    ...
    Export = @{
        ...
        TableNamePrefix = 'AIFoundryHubsTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Hub Name'
    ...
    SourceCollector = 'Modules/Public/InventoryModules/AI/AIFoundryHubs.ps1'
}
