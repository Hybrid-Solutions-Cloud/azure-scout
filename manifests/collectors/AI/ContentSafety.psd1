#
# GENERATED by scripts/ConvertTo-ScoutCollectorDefinition.ps1 from Modules/Public/InventoryModules/AI/ContentSafety.ps1 (AB#5660).
...
@{
    ...
    AdditionalFilter = '$_.Kind -eq ''ContentSafety'''
...
'@
    ...
    Export = @{
        WorksheetName = 'Content Safety'
        TableNamePrefix = 'ContSafTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
    ...
    SourceCollector = 'Modules/Public/InventoryModules/AI/ContentSafety.ps1'
}
