#
# GENERATED by scripts/ConvertTo-ScoutCollectorDefinition.ps1 from Modules/Public/InventoryModules/AI/MLModels.ps1 (AB#5660).
...
'@
    ...
    Export = @{
        ...
        TableNamePrefix = 'MLModelsTable_'
        Columns = @(
            'Workspace Name'
            'Subscription'
            'Resource Group'
    ...
    SourceCollector = 'Modules/Public/InventoryModules/AI/MLModels.ps1'
}
