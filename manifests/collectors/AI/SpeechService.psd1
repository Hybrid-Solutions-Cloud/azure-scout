#
# GENERATED by scripts/ConvertTo-ScoutCollectorDefinition.ps1 from Modules/Public/InventoryModules/AI/SpeechService.ps1 (AB#5660).
...
@{
    ...
    AdditionalFilter = '$_.Kind -eq ''SpeechServices'''
...
'@
    ...
    AdditionalRowLoops = @(
        @{
            ...
            # loop always runs at least once and a Speech service account keeps its row.
            #
    ...
    Export = @{
        WorksheetName = 'Speech Service'
        TableNamePrefix = 'SpeechTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
        ...
        ConditionalText = @(
            ...
            'New-ConditionalText enabled -Range I:I'
        )
    }

    SourceCollector = 'Modules/Public/InventoryModules/AI/SpeechService.ps1'
}
