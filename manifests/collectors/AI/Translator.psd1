#
# GENERATED by scripts/ConvertTo-ScoutCollectorDefinition.ps1 from Modules/Public/InventoryModules/AI/Translator.ps1 (AB#5660).
...
@{
    ...
    AdditionalFilter = '$_.Kind -eq ''TextTranslation'''
...
'@
    ...
    AdditionalRowLoops = @(
        @{
            ...
            # loop always runs at least once and a Translator account keeps its row.
            #
    ...
    Export = @{
        WorksheetName = 'Translator'
        TableNamePrefix = 'TranslaTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
    ...
    SourceCollector = 'Modules/Public/InventoryModules/AI/Translator.ps1'
}
