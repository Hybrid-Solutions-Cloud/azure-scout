...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Domain Name Label Scope'
            Expression = '$data.autoGeneratedDomainNameLabelScope'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Planetary Computer'
        TableNamePrefix = 'PlanetaryComputerGeoCatalogsTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
