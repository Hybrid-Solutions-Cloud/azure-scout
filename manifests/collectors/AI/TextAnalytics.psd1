#
# GENERATED by scripts/ConvertTo-ScoutCollectorDefinition.ps1 from Modules/Public/InventoryModules/AI/TextAnalytics.ps1 (AB#5660).
...
@{
    ...
    AdditionalFilter = '$_.Kind -eq ''TextAnalytics'''
...
'@
    ...
    AdditionalRowLoops = @(
        @{
            ...
            # loop always runs at least once and a Language (Text Analytics) account keeps its
            # row.
            #
    ...
    Fields = @(
        ...
        @{
            Name = 'Quota Limit'
            Expression = '$data.quotaLimit.rules.''count'''
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Language'
        TableNamePrefix = 'LanguTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
    ...
    SourceCollector = 'Modules/Public/InventoryModules/AI/TextAnalytics.ps1'
}
