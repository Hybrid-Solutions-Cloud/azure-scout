#
# GENERATED by scripts/ConvertTo-ScoutCollectorDefinition.ps1 from Modules/Public/InventoryModules/AI/CustomVision.ps1 (AB#5660).
...
@{
    ...
    AdditionalFilter = '$_.Kind -like ''CustomVision.*'''
...
'@
    ...
    AdditionalRowLoops = @(
        @{
            ...
            # loop always runs at least once and a Custom Vision training or prediction account
            # keeps its row.
            #
    ...
    Export = @{
        WorksheetName = 'Custom Vision'
        TableNamePrefix = 'CustomViTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
    ...
    SourceCollector = 'Modules/Public/InventoryModules/AI/CustomVision.ps1'
}
