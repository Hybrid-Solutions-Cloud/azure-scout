#
# GENERATED by scripts/ConvertTo-ScoutCollectorDefinition.ps1 from Modules/Public/InventoryModules/AI/ComputerVision.ps1 (AB#5660).
...
@{
    ...
    AdditionalFilter = '$_.Kind -eq ''ComputerVision'''
...
'@
    ...
    AdditionalRowLoops = @(
        @{
            ...
            # loop always runs at least once and a Computer Vision account keeps its row.
            #
    ...
    Export = @{
        WorksheetName = 'Computer Vision'
        TableNamePrefix = 'VisionTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
    ...
    SourceCollector = 'Modules/Public/InventoryModules/AI/ComputerVision.ps1'
}
