...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '$data.validationMethod'
        }
        @{
            Name = 'Domain Control Validation'
            Expression = '[string]$data.domainControlValidation'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Container App Managed Certs'
        TableNamePrefix = 'ContainerAppManagedCertificatesTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
