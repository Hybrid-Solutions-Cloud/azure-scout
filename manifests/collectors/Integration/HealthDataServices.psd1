...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Authority'
            Expression = '$data.authenticationConfiguration.authority'
        }
        @{
            Name = 'SMART Proxy Enabled'
            Expression = '[string]$data.authenticationConfiguration.smartProxyEnabled'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Health Data Services'
        TableNamePrefix = 'HealthDataServicesTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
