...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '$data.backendService.serviceUrl'
        }
        @{
            Name = 'API Type'
            Expression = '$data.apiType'
        }
        @{
            Name = 'Connection Params'
            Expression = '[string]@($data.connectionParameters.psobject.properties).Count'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Logic Apps Connectors'
        TableNamePrefix = 'LogicAppsCustomConnectorsTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
