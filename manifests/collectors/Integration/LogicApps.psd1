...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '$data.accessEndpoint'
        }
        @{
            Name = 'Integration Account'
            Expression = '$IntegrationAccount'
        }
        @{
            Name = 'Trigger Count'
            Expression = '[string]@($data.definition.triggers.psobject.properties).Count'
        }
        @{
            Name = 'Action Count'
            Expression = '[string]@($data.definition.actions.psobject.properties).Count'
        }
        @{
            Name = 'Created Time'
            Expression = '[string]$data.createdTime'
        }
        @{
            Name = 'Changed Time'
            Expression = '[string]$data.changedTime'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Logic Apps'
        TableNamePrefix = 'LogicAppsTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
