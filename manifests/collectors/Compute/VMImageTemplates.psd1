...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Source Type'
            Expression = '$data.source.type'
        }
        @{
            Name = 'Build Timeout Minutes'
            Expression = '[string]$data.buildTimeoutInMinutes'
        }
        @{
            Name = 'Identity Type'
        ...
        @{
            ...
            Expression = '$data.stagingResourceGroup'
        }
        @{
            Name = 'Last Run State'
            Expression = '$data.lastRunStatus.runState'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'VM Image Builder'
        TableNamePrefix = 'VMImageTemplatesTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
