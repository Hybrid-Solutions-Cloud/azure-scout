#
# GENERATED by scripts/ConvertTo-ScoutCollectorDefinition.ps1 from Modules/Public/InventoryModules/Compute/CloudServices.ps1 (AB#5660).
...
'@
    ...
    Export = @{
        WorksheetName = 'CloudServices'
        TableNamePrefix = 'CloudServicesTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
    ...
    SourceCollector = 'Modules/Public/InventoryModules/Compute/CloudServices.ps1'
}
