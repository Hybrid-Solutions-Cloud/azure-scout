...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '[string]$data.apiKeyEnabled'
        }
        @{
            Name = 'Providers Count'
            Expression = '[string]@($data.providers).Count'
        }
        @{
            Name = 'Identity Type'
        ...
        @{
            ...
            Expression = '$QuantumStorageAccount'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Quantum Workspaces'
        TableNamePrefix = 'QuantumWorkspacesTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
