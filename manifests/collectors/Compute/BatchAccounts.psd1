...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Pool Allocation Mode'
            Expression = '$data.poolAllocationMode'
        }
        @{
        ...
        @{
            ...
            Expression = '$data.encryption.keySource'
        }
        @{
            Name = 'Auto Storage Account'
            Expression = '$AutoStorageAccount'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Batch Accounts'
        TableNamePrefix = 'BatchAccountsTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
