...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Regular Priority Allocation Strategy'
            Expression = '$data.regularPriorityProfile.allocationStrategy'
        }
        @{
            Name = 'Spot Priority Allocation Strategy'
            Expression = '$data.spotPriorityProfile.allocationStrategy'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Compute Fleet'
        TableNamePrefix = 'ComputeFleetTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
            ...
            'Identity Type'
            'Zones'
            'Regular Priority Allocation Strategy'
            'Spot Priority Allocation Strategy'
            'Retiring Feature'
            'Retiring Date'
            'Resource U'
        )
