#
# GENERATED by scripts/ConvertTo-ScoutCollectorDefinition.ps1 from Modules/Public/InventoryModules/Analytics/Synapse.ps1 (AB#5660).
...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '[string]$pvt'
        }
        @{
            Name = 'Double Encryption Enabled'
            Expression = '[string]$data.encryption.doubleEncryptionEnabled'
        }
        @{
            Name = 'Trusted Service Bypass Enabled'
            Expression = '$data.trustedServiceBypassEnabled'
        }
        @{
            Name = 'SQL Administrator Login'
            Expression = '$data.sqlAdministratorLogin'
        }
        @{
            Name = 'Scope Enabled'
            Expression = '[string]$data.extraProperties.IsScopeEnabled'
        }
        @{
            Name = 'Workspace Type'
            Expression = '[string]$data.extraProperties.WorkspaceType'
        }
        @{
            Name = 'Prevent Data Exfiltration'
            Expression = '[string]$data.managedVirtualNetworkSettings.preventDataExfiltration'
        }
        @{
            Name = 'Managed Virtual Network'
            Expression = '$data.managedVirtualNetwork'
        }
        @{
            Name = 'Managed ResourceGroup'
            Expression = '$data.managedResourceGroupName'
        }
        @{
            Name = 'Resource U'
    ...
    Export = @{
        WorksheetName = 'Synapse'
        TableNamePrefix = 'SynapseTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
    ...
    SourceCollector = 'Modules/Public/InventoryModules/Analytics/Synapse.ps1'
}
