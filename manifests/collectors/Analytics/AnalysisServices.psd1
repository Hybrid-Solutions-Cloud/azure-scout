...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Query Pool Connection Mode'
            Expression = '$data.querypoolConnectionMode'
        }
        @{
            Name = 'Firewall State'
            Expression = '$data.ipV4FirewallSettings.firewallState'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Analysis Services'
        TableNamePrefix = 'AnalysisServicesTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
