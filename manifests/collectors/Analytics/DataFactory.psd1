...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Repo Configuration Type'
            Expression = '$data.repoConfiguration.type'
        }
        @{
            Name = 'Identity Type'
        ...
        @{
            Name = 'Create Time'
            Expression = '[string]$data.createTime'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Data Factory'
        TableNamePrefix = 'DataFactoryTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
