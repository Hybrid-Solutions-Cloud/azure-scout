...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '$data.clusterVersion'
        }
        @{
            Name = 'Cluster Kind'
            Expression = '$data.clusterDefinition.kind'
        }
        @{
            Name = 'Cluster State'
            Expression = '$data.clusterState'
        }
        @{
            Name = 'OS Type'
        ...
        @{
            ...
            Expression = '$data.minSupportedTlsVersion'
        }
        @{
            Name = 'Public Network Access'
            Expression = '$data.networkProperties.publicNetworkAccess'
        }
        @{
            Name = 'Encryption In Transit'
            Expression = '[string]$data.encryptionInTransitProperties.isEncryptionInTransitEnabled'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'HDInsight'
        TableNamePrefix = 'HDInsightTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
