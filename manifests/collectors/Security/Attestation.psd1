...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'TPM Attestation Auth'
            Expression = '$data.tpmAttestationAuthentication'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Attestation'
        TableNamePrefix = 'AttestationTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
