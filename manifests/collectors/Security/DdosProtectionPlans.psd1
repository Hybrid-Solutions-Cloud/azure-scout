...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Protected VNETs'
            Expression = '[string]@($data.virtualNetworks).Count'
        }
        @{
            Name = 'Public IP Count'
            Expression = '[string]@($data.publicIPAddresses).Count'
        }
        @{
            Name = 'Resource GUID'
            Expression = '$data.resourceGuid'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'DDoS Protection Plans'
        TableNamePrefix = 'DdosProtectionPlansTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
