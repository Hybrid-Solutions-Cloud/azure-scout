...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Sync Scope'
            Expression = '$data.syncScope'
        }
        @{
            Name = 'TLS v1 Enabled'
            Expression = '$data.domainSecuritySettings.tlsV1'
        }
        @{
            Name = 'NTLM v1 Enabled'
            Expression = '$data.domainSecuritySettings.ntlmV1'
        }
        @{
            Name = 'Kerberos RC4'
            Expression = '$data.domainSecuritySettings.kerberosRc4Encryption'
        }
        @{
            Name = 'LDAPS Enabled'
            Expression = '$data.ldapsSettings.ldaps'
        }
        @{
            Name = 'LDAPS External'
            Expression = '$data.ldapsSettings.externalAccess'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Entra Domain Services'
        TableNamePrefix = 'EntraDomainServicesTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
