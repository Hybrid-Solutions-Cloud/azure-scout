...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '$data.securityDomainProperties.activationStatus'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Managed HSM'
        TableNamePrefix = 'ManagedHSMTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
