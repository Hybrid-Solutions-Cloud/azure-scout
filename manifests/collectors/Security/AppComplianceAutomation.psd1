...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Trigger Time'
            Expression = '[string]$data.triggerTime'
        }
        @{
            Name = 'Time Zone'
        ...
        @{
            Name = 'Resource Count'
            Expression = '[string]@($data.resources).Count'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'App Compliance Automation'
        TableNamePrefix = 'AppComplianceAutomationTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
