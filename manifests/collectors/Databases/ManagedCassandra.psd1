...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '$data.cassandraVersion'
        }
        @{
            Name = 'Authentication Method'
            Expression = '$data.authenticationMethod'
        }
        @{
            Name = 'Audit Logging Enabled'
            Expression = '[string]$data.cassandraAuditLoggingEnabled'
        }
        @{
            Name = 'Identity Type'
    ...
    Export = @{
        WorksheetName = 'Managed Cassandra'
        TableNamePrefix = 'ManagedCassandraTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
