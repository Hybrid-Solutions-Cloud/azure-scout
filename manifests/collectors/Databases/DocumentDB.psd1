...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Server Version'
            Expression = '$data.serverVersion'
        }
        @{
            Name = 'High Availability Mode'
            Expression = '$data.highAvailability.targetMode'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'DocumentDB (vCore Mongo)'
        TableNamePrefix = 'DocumentDBTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
