...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '$data.encryptionState'
        }
        @{
            Name = 'Firewall State'
            Expression = '$data.firewallState'
        }
        @{
            Name = 'Endpoint'
        ...
        @{
            Name = 'Retired'
            Expression = '''Azure Data Lake Storage Gen1 was retired 2024-02-29'''
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Data Lake Store Gen1'
        TableNamePrefix = 'DataLakeStoreGen1Table_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
