...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Base Size (TiB)'
            Expression = '[string]$data.baseSizeTiB'
        }
        @{
            Name = 'Extended Size (TiB)'
            Expression = '[string]$data.extendedCapacitySizeTiB'
        }
        @{
            Name = 'Protocol Type'
            Expression = '$data.protocolType'
        }
        @{
            Name = 'Encryption'
    ...
    Export = @{
        WorksheetName = 'Elastic SAN'
        TableNamePrefix = 'ElasticSanTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
