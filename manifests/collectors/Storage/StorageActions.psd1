...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Enabled'
            Expression = '[string]$data.storageTaskProperties.enabled'
        }
        @{
            Name = 'Description'
            Expression = '$data.storageTaskProperties.description'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Storage Actions'
        TableNamePrefix = 'StorageActionsTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
