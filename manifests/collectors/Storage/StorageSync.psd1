...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '$data.incomingTrafficPolicy'
        }
        @{
            Name = 'Server Name'
        ...
        @{
            Name = 'Server OS'
            Expression = '$data.serverOSVersion'
        }
        @{
            Name = 'Agent Version'
        ...
        @{
            Name = 'Server Status'
            Expression = '$data.serverManagementErrorCode'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Storage Sync Services'
        TableNamePrefix = 'StorageSyncTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
