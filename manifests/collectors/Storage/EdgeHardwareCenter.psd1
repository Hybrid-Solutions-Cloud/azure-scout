...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Order Stage'
            Expression = '$data.orderStageHistory'
        }
        @{
            Name = 'Product Family'
            Expression = '$data.productDetails.hierarchyInformation.productFamilyName'
        }
        @{
            Name = 'Product Line'
            Expression = '$data.productDetails.hierarchyInformation.productLineName'
        }
        @{
            Name = 'Quantity'
            Expression = '[string]$data.productDetails.count'
        }
        @{
            Name = 'Address State'
            Expression = '$data.addressValidationStatus'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Edge Hardware Center'
        TableNamePrefix = 'EdgeHardwareCenterTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
