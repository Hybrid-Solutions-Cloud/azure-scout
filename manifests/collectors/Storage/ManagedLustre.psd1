...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Storage Capacity (TiB)'
            Expression = '[string]$data.storageCapacityTiB'
        }
        @{
            Name = 'Filesystem Subnet'
            Expression = '$data.filesystemSubnet'
        }
        @{
            Name = 'Health State'
            Expression = '$data.health.state'
        }
        @{
            Name = 'Zones'
    ...
    Export = @{
        WorksheetName = 'Managed Lustre'
        TableNamePrefix = 'ManagedLustreTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
