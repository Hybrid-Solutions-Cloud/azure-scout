...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Schema Registry Id'
            Expression = '$data.schemaRegistryRef.resourceId'
        }
        @{
            Name = 'Identity Type'
        ...
        @{
            ...
            Expression = '$1.extendedLocation.name'
        }
        @{
            Name = 'Extended Location Type'
            Expression = '$1.extendedLocation.type'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'IoT Operations'
        TableNamePrefix = 'IoTOperationsTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
