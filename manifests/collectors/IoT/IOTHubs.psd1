#
# GENERATED by scripts/ConvertTo-ScoutCollectorDefinition.ps1 from Modules/Public/InventoryModules/IoT/IOTHubs.ps1 (AB#5660).
...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'IP Filter Rules'
            Expression = '[string]$IpFilter'
        }
        @{
            Name = 'Event Retention Time In Days'
            Expression = '[string]$data.eventHubEndpoints.events.retentionTimeInDays'
        }
        @{
            Name = 'Event Partition Count'
            Expression = '[string]$data.eventHubEndpoints.events.partitionCount'
        }
        @{
            Name = 'Events Path'
            Expression = '[string]$data.eventHubEndpoints.events.path'
        }
        @{
            Name = 'Max Delivery Count'
            Expression = '[string]$data.cloudToDevice.maxDeliveryCount'
        }
        @{
            Name = 'Host Name'
    ...
    Export = @{
        WorksheetName = 'IOTHubs'
        TableNamePrefix = 'IOTHubsTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
    ...
    SourceCollector = 'Modules/Public/InventoryModules/IoT/IOTHubs.ps1'
}
