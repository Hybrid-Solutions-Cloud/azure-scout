...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '$data.serviceOperationsHostName'
        }
        @{
            Name = 'Allocation Policy'
            Expression = '$data.allocationPolicy'
        }
        @{
        ...
        @{
            Name = 'Linked IoT Hubs'
            Expression = '[string]@($data.iotHubs).Count'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'IoT DPS'
        TableNamePrefix = 'DeviceProvisioningServicesTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
