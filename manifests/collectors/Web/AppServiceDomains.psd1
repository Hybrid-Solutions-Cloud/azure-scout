...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '$data.registrationStatus'
        }
        @{
        ...
        @{
            ...
            Expression = '[string]$data.expirationTime'
        }
        @{
            Name = 'Auto Renew'
        ...
        @{
            Name = 'Privacy'
            Expression = '[string]$data.privacy'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'App Service Domains'
        TableNamePrefix = 'AppServiceDomainsTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
