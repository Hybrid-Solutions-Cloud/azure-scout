...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '$data.internalLoadBalancingMode'
        }
        @{
            Name = 'Dedicated Host Count'
            Expression = '[string]$data.dedicatedHostCount'
        }
        @{
            Name = 'Zone Redundant'
            Expression = '[string]$data.zoneRedundant'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'App Service Environments'
        TableNamePrefix = 'AppServiceEnvironmentsTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
