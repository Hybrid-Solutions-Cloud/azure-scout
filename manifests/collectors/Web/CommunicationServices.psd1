...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '$data.domainManagement'
        }
        @{
            Name = 'Verification State'
            Expression = '$data.verificationStates.Domain.status'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Communication Services'
        TableNamePrefix = 'CommunicationServicesTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
