...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Dashboard URI'
            Expression = '$data.dashboardUri'
        }
        @{
            Name = 'Local Auth'
            Expression = '$data.localAuth'
        }
        @{
            Name = 'Regional Affinity'
            Expression = '$data.regionalAffinity'
        }
        @{
            Name = 'Reporting'
            Expression = '$data.reporting'
        }
        @{
            Name = 'Scalable Execution'
            Expression = '$data.scalableExecution'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Playwright Workspaces'
        TableNamePrefix = 'PlaywrightTestingTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
