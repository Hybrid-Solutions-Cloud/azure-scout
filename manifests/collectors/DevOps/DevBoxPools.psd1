...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '$data.devBoxDefinitionName'
        }
        @{
            Name = 'Network Connection'
            Expression = '$data.networkConnectionName'
        }
        @{
            Name = 'Local Admin'
        ...
        @{
            Name = 'Admin Status'
            Expression = '$data.localAdministrator'
        }
        @{
            Name = 'Stop On Disconnect'
            Expression = '$data.stopOnDisconnect.status'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Dev Box Pools'
        TableNamePrefix = 'DevBoxPoolsTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
