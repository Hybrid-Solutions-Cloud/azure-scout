...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Lab Storage Type'
            Expression = '$data.labStorageType'
        }
        @{
            Name = 'Premium Data Disks'
            Expression = '$data.premiumDataDisks'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'DevTest Labs'
        TableNamePrefix = 'DevTestLabsTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
