...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '[string]$data.enablePurgeProtection'
        }
        @{
            Name = 'Soft Delete Days'
            Expression = '[string]$data.softDeleteRetentionInDays'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'App Configuration'
        TableNamePrefix = 'AppConfigurationTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
