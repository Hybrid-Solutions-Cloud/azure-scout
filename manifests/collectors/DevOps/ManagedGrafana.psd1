...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Grafana Major Version'
            Expression = '[string]$data.grafanaMajorVersion'
        }
        @{
        ...
        @{
            ...
            Expression = '$data.deterministicOutboundIP'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Managed Grafana'
        TableNamePrefix = 'ManagedGrafanaTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
