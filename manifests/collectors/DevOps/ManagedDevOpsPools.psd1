...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Maximum Agents'
            Expression = '[string]$data.maximumConcurrency'
        }
        @{
            Name = 'Organisation Kind'
            Expression = '$data.organizationProfile.kind'
        }
        @{
            Name = 'Agent OS'
            Expression = '$data.fabricProfile.kind'
        }
        @{
            Name = 'Identity Type'
    ...
    Export = @{
        WorksheetName = 'Managed DevOps Pools'
        TableNamePrefix = 'ManagedDevOpsPoolsTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
