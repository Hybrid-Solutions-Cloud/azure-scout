#
# GENERATED by scripts/ConvertTo-ScoutCollectorDefinition.ps1 from Modules/Public/InventoryModules/Networking/PrivateEndpoint.ps1 (AB#5660).
...
'@
    ...
    Fields = @(
        ...
        @{
            ...
            Expression = '(Get-AZSCSafeProperty -InputObject $data -Path ''privateLinkServiceConnections.name'' -Enumerate)'
        }
        @{
            Name = 'Private Link Status'
            Expression = '(Get-AZSCSafeProperty -InputObject $data -Path ''privatelinkserviceconnections.properties.privateLinkServiceConnectionState.status'' -Enumerate)'
        }
        @{
            Name = 'Private Link Resource Type'
            Expression = '[string](Get-AZSCSafeProperty -InputObject $data -Path ''privatelinkserviceconnections.properties.groupids'' -Enumerate)'
        }
        @{
            Name = 'Private Link Target Resource'
            Expression = '[string](Get-AZSCSafeProperty -InputObject $data -Path ''privatelinkserviceconnections.properties.privatelinkserviceid'' -Enumerate)'
        }
        @{
            Name = 'IP Address'
    ...
    Export = @{
        WorksheetName = 'Private Endpoint'
        TableNamePrefix = 'PvtEndpointTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
    ...
    SourceCollector = 'Modules/Public/InventoryModules/Networking/PrivateEndpoint.ps1'
}
