...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Quantity'
            Expression = '[string]$data.quantity'
        }
        @{
            Name = 'Term'
        ...
        @{
            Name = 'Billing Plan'
            Expression = '$data.billingPlan'
        }
        @{
            Name = 'Benefit Start'
            Expression = '[string]$data.benefitStartTime'
        }
        @{
            Name = 'Expiry Date'
            Expression = '[string]$data.expiryDate'
        }
        @{
            Name = 'Renew'
            Expression = '[string]$data.renew'
        }
        @{
    ...
    Export = @{
        ...
        TableNamePrefix = 'ReservationsTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
