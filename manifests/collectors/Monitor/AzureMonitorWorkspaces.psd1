...
'@
    ...
    Fields = @(
        ...
        @{
            Name = 'Prometheus Query Endpoint'
            Expression = '$data.metrics.prometheusQueryEndpoint'
        }
        @{
            Name = 'Data Collection Endpoint'
            Expression = '$DataCollectionEndpoint'
        }
        @{
            Name = 'Data Collection Rule'
            Expression = '$DataCollectionRule'
        }
        @{
    ...
    Export = @{
        WorksheetName = 'Azure Monitor Workspaces'
        TableNamePrefix = 'AzureMonitorWorkspacesTable_'
        Columns = @(
            'Subscription'
            'Resource Group'
            'Name'
