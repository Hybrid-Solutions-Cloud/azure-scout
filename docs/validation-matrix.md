...
evidence from the previous one — see [Output Files & Formats](output.md).

## Related

- [Testing](testing.md) — running and writing the Pester suite
- [Category Reference](category-reference.md) — the category and alias mapping
- [Permissions](permissions.md) — the roles each check needs
