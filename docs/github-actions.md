...
**application** permissions with admin consent granted. See [Permissions](permissions.md).
...
Category values and their aliases are in the [Category Reference](category-reference.md).
...
| Entra worksheets empty with `scope: All` | Graph application permissions missing or unconsented | See [Permissions](permissions.md) |
...
- [Authentication](authentication.md) — every supported login method
- [Category Reference](category-reference.md) — category values and aliases
- [Parameters](parameters.md) — the full parameter set behind these inputs
