...
Describe 'Manifest collector runtime catalog' {
    It 'discovers every shipped collector without a retired collector root' {
        ...
        $Actual.Count | Should -Be 245   # 174 through v3.0.9, +68 from AB#6741, -6 retired by AB#6767/AB#6842, +4 from AB#6779, +1 ArcSites (AB#6801), +1 ReservationUtilization (AB#6829), +2 VerifiedIDProfiles/VerifiedIDConfiguration (AB#7097), +1 ExternalIdentities (AB#7098)
        @($Actual | Where-Object {
