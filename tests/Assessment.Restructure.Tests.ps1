...
Describe 'AB#6799 — every rule file records a verifiedAgainst guidance date' {
    It 'has a non-empty verifiedAgainst string' {
        $offenders = Get-AllRuleDocs | Where-Object {
            -not ($_.Doc.ContainsKey('verifiedAgainst') -and $_.Doc.verifiedAgainst)
